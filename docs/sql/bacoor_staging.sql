...
-- Dumping data for table bacoor_dev.b_email_audit: ~0 rows (approximately)
...
-- Dumping data for table bacoor_dev.sys_roles: ~0 rows (approximately)
...
-- Dumping data for table bacoor_dev.sys_users: ~16 rows (approximately)
...
INSERT INTO `sys_users` (`id`, `firstname`, `lastname`, `mi`, `designation`, `address`, `contacts`, `email_add`, `signature`, `searchable`, `district`, `date_created`, `user_created`, `date_last_modified`, `user_last_modified`, `deleted`) VALUES
	...
	(3, 'Victorino', 'Guerrero', '', '', '', '', 'joshauza@gmail.com', 'sig.png', 1, 2, '0000-00-00', '', '2014-07-25', 'khalid', 0),
	(4, 'Avelino', 'Solis', 'K', '', 'Manila', '09156473743', 'joshauza@gmail.com', 'sig.png', 1, 1, '0000-00-00', '', '2014-08-02', 'khalid', 0),
	(5, 'Edwin', 'Gawaran', 'K', '', 'Brgy. Holy Spirit Mandaluyong', '09156473743', 'joshauza@gmail.com', 'sig.png', 1, 1, '0000-00-00', '', '2014-08-08', 'egawaran', 0),
	(6, 'Miguel', 'Bautista', '', '', '', '', 'joshauza@gmail.com', 'sig.png', 1, 1, '0000-00-00', '', '2014-07-25', 'mbautista', 0),
	...
	(9, 'Rowena', 'Bautista Mendiola', '', '', '', '', 'joshauza@gmail.com', 'sig.png', 1, 1, '0000-00-00', '', '2014-07-25', 'rbmendiola', 0),
	(10, 'Bayani', 'De Leon', '', '', '', '', 'joshauza@gmail.com', 'sig.png?1407857091', 1, 2, '0000-00-00', '', '2014-08-12', 'bdeleon', 0),
	(11, 'Gaudencio', 'Nolasco', '', '', '', '', 'joshauza@gmail.com', 'sig.png', 1, 2, '0000-00-00', '', '2014-07-25', 'gnolasco', 0),
	(12, 'Hernando', 'Gutierrez', '', '', '', '', 'joshauza@gmail.com', 'sig.png', 1, 2, '0000-00-00', '', '2014-07-25', 'hgutierrez', 0),
	(13, 'Leandro', 'De Leon', '', '', '', '', 'joshauza@gmail.com', 'sig.png?1407857722', 1, 2, '0000-00-00', '', '2014-08-12', 'ldeleon', 0),
	(14, 'Reynaldo', 'Palabrica', '', '', '', '', 'joshauza@gmail.com', 'sig.png', 1, 2, '0000-00-00', '', '2014-07-25', 'rpalabrica', 0),
...
-- Dumping data for table bacoor_dev.sys_user_roles: ~16 rows (approximately)
...
INSERT INTO `sys_user_roles` (`id`, `sys_user_id`, `sys_role_id`, `username`, `password`, `pwc`, `status`, `date_created`, `user_created`, `date_last_modified`, `user_last_modified`, `deleted`) VALUES
	...
	(3, 3, 5, 'vguerrero', 'a', 0, 'REG', '0000-00-00', '', '2014-07-30', 'admin1', 0),
	(4, 4, 5, 'asolis', 'a', 0, 'REG', '0000-00-00', '', '2014-07-30', 'admin1', 0),
	(5, 5, 5, 'egawaran', 'a', 0, 'REG', '0000-00-00', '', '2014-07-30', 'admin1', 0),
	(6, 6, 5, 'mbautista', 'a', 0, 'REG', '0000-00-00', '', '2014-07-30', 'admin1', 0),
	(7, 7, 5, 'rfabian', 'a', 0, 'REG', '0000-00-00', '', '2014-07-30', 'admin1', 0),
	(8, 8, 5, 'vdecastro', 'a', 0, 'REG', '0000-00-00', '', '2014-07-30', 'admin1', 0),
	(9, 9, 5, 'rbmendiola', 'a', 0, 'REG', '0000-00-00', '', '2014-07-31', 'admin1', 0),
	(10, 10, 5, 'bdeleon', 'a', 0, 'REG', '0000-00-00', '', '2014-08-04', 'admin1', 0),
	(11, 11, 5, 'gnolasco', 'a', 0, 'REG', '0000-00-00', '', '0000-00-00', '', 0),
	(12, 12, 5, 'hgutierrez', 'a', 0, 'REG', '0000-00-00', '', '0000-00-00', '', 0),
	(13, 13, 5, 'ldeleon', 'a', 0, 'REG', '0000-00-00', '', '0000-00-00', '', 0),
	(14, 14, 5, 'rpalabrica', 'a', 0, 'REG', '0000-00-00', '', '0000-00-00', '', 0),
	(15, 15, 5, 'rjavier', 'a', 0, 'REG', '0000-00-00', '', '2014-07-31', 'admin1', 0),
